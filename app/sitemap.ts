...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogRoutes: MetadataRoute.Sitemap = BLOG_POSTS.map((post) => ({
    ...
    lastModified: currentDate,
    changeFrequency: post.slug === "ai-extinction-warnings-and-risks" ? "daily" : post.featured ? "daily" : "weekly",
    priority: post.slug === "ai-extinction-warnings-and-risks" ? 0.9 : post.featured ? 0.85 : 0.7,
  }));
