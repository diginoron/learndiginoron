      ...
      <div className="glass-panel p-8 sm:p-12 rounded-3xl border border-slate-800 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-white">ماموریت دیجی نورون</h2>
            <p className="text-xs text-gray-300 leading-relaxed">
              دیجی نورون (DigiNoron) به عنوان یکی از پیشگامان تحول دیجیتال در کشور، سامانه آکادمیک خود را با دامنه اختصاصی <span className="text-cyan-400 font-mono">learn.diginoron.com</span> جهت ارتقای سطح سواد و مهارت‌های هوش مصنوعی ایجاد نموده است.
            </p>
            <p className="text-xs text-gray-300 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-slate-800">
          <div className="p-6 bg-slate-900/80 rounded-2xl border border-cyan-500/20 space-y-3">
          ...
          <div className="p-6 bg-slate-900/80 rounded-2xl border border-purple-500/20 space-y-3">
