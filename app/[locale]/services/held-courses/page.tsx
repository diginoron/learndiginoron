...
export default async function HeldCoursesPage({ params }: PageProps) {
  ...
  const labels = {
    ...
    fa: {
      ...
      customOfferDesc: "تیم اساتید و متخصصان دیجی نورون آماده طراحی و اجرای کارگاه‌های تخصصی متناسب با نیاز اتحادیه‌ها، انجمن‌های صنفی، نهادهای دولتی و شرکت‌های خصوصی در سراسر ایران به صورت حضوری و آنلاین می‌باشد.",
