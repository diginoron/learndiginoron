...
export const COMMON_TRANSLATIONS: Record<Locale, CommonTranslations> = {
  en: {
    ...
    footer: {
      ...
      address: "Tehran, Iran - Technology Innovation Center",
  ...
  fa: {
    ...
    nav: {
      ...
      heldCoursesDesc: "سوابق برگزاری در پتروشیمی تبریز، کتابخانه ملی، شهرداری تهران و ...",
    ...
    footer: {
      ...
      address: "تهران، خیابان ولیعصر، تقاطع فاطمی، پارک علم و فناوری",
      email: "diginoron@gmail.com",
      phone: "۰۲۱۸۸۲۵۲۴۹۷",
  ...
  ar: {
    ...
    footer: {
      ...
      address: "طهران - مركز الابتكار وحاضنة التقنية المتقدمة",
      email: "diginoron@gmail.com",
      phone: "021-88252497",
